...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-between">
            <h1 class="logo"><a href="index.html">XML Sitemap Generator</a></h1>
        ...
        <div class="container">
            ...
            <div class="copyright-wrap d-md-flex py-4">
                <div class="me-md-auto text-center text-md-start">
                    <div class="copyright">
                        &copy; Copyright <strong><span>Free Google Unlimited XML Sitemap Generator</span></strong>. All
                        Rights Reserved
                    </div>
                    <div class="credits">
                        ...
                        Free Google XML Sitemap Generator by <a href="https://juliwebconsultancy.com"
                            class="text-white">Juli
                            Web
                            Consultancy</a>.
                    </div>
                </div>
